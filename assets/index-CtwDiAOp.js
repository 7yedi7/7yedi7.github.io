import{d as s,r as n,T as i,j as t}from"./green-hn3UDYiG.js";import{P as l}from"./button-Ct2sEPvU.js";const f=({Icon:o,LightTextColor:a="#555f6e",DarkTextColor:r="#f5f5f5"})=>{const{darkMode:e}=n.useContext(i);return t.jsx(p,{children:t.jsx("div",{className:`${e?"btn-smallDark":"btn-small"} relative`,children:t.jsx("div",{className:`${e?"btn-small-contentDark":"btn-btn-small-content"} `,children:t.jsxs("span",{className:`${e?"spanTextDark":"spanText"} `,children:[o&&t.jsx(o,{style:{color:e?r:a},className:"w-5 h-5"}),o==l?t.jsx("input",{className:"opacity-0 absolute top-0 left-0 z-10 p-3 cursor-pointer",type:"color",value:"#44db1a"}):null]})})})})},p=s.div`
  .btn-small {
    position: relative;
    padding: 0;
